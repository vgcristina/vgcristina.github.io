...
export const publications = [
	{
	  ...
	  abstract: `
		<p>CineAtmos es una aplicación móvil desarrollada en Kotlin que permite a los usuarios descubrir películas y series, además de interactuar entre ellos a modo de red social. Integra la API de TMDb para obtener contenido actualizado del mundo del cine, y utliza Firebase para gestionar usuarios, publicaciones y la comunidad.</p>
